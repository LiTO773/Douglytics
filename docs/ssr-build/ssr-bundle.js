...
module.exports = {"home":"home__XnpRR"};
...
var header_Header = function (_Component) {
	...
	Header.prototype.render = function render() {
		return Object(preact_min["h"])(
			'div',
			{ 'class': header_style_default.a.home },
			Object(preact_min["h"])(
				'h1',
				{ 'class': header_style_default.a.title },
				'Did Doug ever say?'
			)
		);
	};
...
var _ref = Object(preact_min["h"])(
	...
	Object(preact_min["h"])(
		'a',
		{ target: 'blank', href: 'https://github.com/LiTO773/Douglytics' },
...
var home__ref = Object(preact_min["h"])(
	'p',
	null,
	'Type the word you want to find out!'
);
...
var home_Home = function (_Component) {
	...
	function Home() {
		...
		return _ret = (_temp = (_this = home__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			word: ""
		}, _this.handleWordInput = function (e) {
			_this.setState({ word: e.target.value });
		}, _this.goTo = function () {
			route('/' + _this.state.word);
	...
	Home.prototype.render = function render() {
		return Object(preact_min["h"])(
			...
			home__ref,
			Object(preact_min["h"])('input', { onChange: this.goTo, onInput: this.handleWordInput, 'class': home_style_default.a.input, placeholder: 'quirks', type: 'text' }),
			Object(preact_min["h"])(
				'button',
				{ onClick: this.goTo, className: 'button' },
				'Let\'s find out!'
			)
		);
	};
...
// EXTERNAL MODULE: ./routes/word/style.css
var word_style = __webpack_require__("HRtO");
var word_style_default = /*#__PURE__*/__webpack_require__.n(word_style);

// CONCATENATED MODULE: ./routes/word/index.js


function word__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function word__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function word__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var word_Word = function (_Component) {
	word__inherits(Word, _Component);

	function Word() {
		var _temp, _this, _ret;

		word__classCallCheck(this, Word);
...
var app__ref3 = Object(preact_min["h"])(word_Word, { path: '/:word' });

var _ref4 = Object(preact_min["h"])(footer_Footer, null);
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__MseGd","input":"input__Pd_I1"};
...
// removed by extract-text-webpack-plugin
module.exports = {"footer":"footer__14P9B"};
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__3ol-y","title":"title__fBWIE"};
